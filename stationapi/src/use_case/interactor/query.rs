                            ...
                            .find(|line| line.line_cd == row.line_cd)
                        {
                            let tt_lines: Vec<Line> = Arc::clone(&tt_lines)
                                ...
                                .map(|l| Line {
                                    ...
                                    line_name_ipa: l.line_name_ipa.clone(),
                                    line_name_r_ipa: l.line_name_r_ipa.clone(),
                            ...
                            let stop = Station {
                                ...
                                station_name_ipa: row.station_name_ipa.clone(),
                                station_name_r_ipa: row.station_name_r_ipa.clone(),
                                ...
                                line_name_ipa: row.line_name_ipa.clone(),
                                line_name_r_ipa: row.line_name_r_ipa.clone(),
