...
CREATE UNLOGGED TABLE public.companies (
    company_cd bigint NOT NULL,
    rr_cd bigint NOT NULL,
    ...
    e_status bigint NOT NULL,
    e_sort bigint NOT NULL
);
...
CREATE UNLOGGED TABLE public.connections (
    id bigint NOT NULL,
    station_cd1 bigint NOT NULL,
    station_cd2 bigint NOT NULL,
...
CREATE UNLOGGED TABLE public.station_station_types (
    id bigint NOT NULL,
    station_cd bigint NOT NULL,
    type_cd bigint NOT NULL,
    line_group_cd bigint NOT NULL,
    pass bigint DEFAULT '0'::bigint
);
...
CREATE UNLOGGED TABLE public.types (
    ...
    color text NOT NULL,
    direction bigint DEFAULT '0'::bigint,
    kind bigint DEFAULT '0'::bigint,
    top_priority bigint DEFAULT '0'::bigint
);
